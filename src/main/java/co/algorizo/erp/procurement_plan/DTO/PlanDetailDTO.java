...
//	product 테이블 후에 수정
	...
	public PlanDetailDTO(int plan_id, String plan_title, String plan_writer, String plan_regdate, String plan_moddate, int pp_id,
			int p_id, int pp_quantity, String pp_delivery_date, int pp_total_price, String p_name, int p_price,
			String p_category) {
		super();
	...
	public String toString() {
		return "PlanDetailDTO [plan_id=" + plan_id + ", plan_title=" + plan_title + ", plan_writer=" + plan_writer
				+ ", plan_regdate=" + plan_regdate + ", plan_moddate=" + plan_moddate + ", pp_id=" + pp_id + ", p_id=" + p_id
				+ ", pp_quantity=" + pp_quantity + ", pp_delivery_date=" + pp_delivery_date + ", pp_total_price="
				+ pp_total_price + ", p_name=" + p_name + ", p_price=" + p_price + ", p_category=" + p_category + "]";
	}
