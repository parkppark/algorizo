	...
	<div id="main">
		...
		<div class="page-heading">
			...
			<section class="section">
				<div class="card">
					<div class="card-header"><h3>재고 목록</h3></div>
					<div class="card-body">
						<div
								...
								<table class="table table-striped dataTable-table" id="table1">
									<thead>
										<tr>
											<th data-sortable="" style="width: 12.8%;"><a href="#"
												class="dataTable-sorter">재고 아이디</a></th>
											<th data-sortable="" style="width: 12.8667%;"><a
												href="#" class="dataTable-sorter">재고 입고 날짜</a></th>
											<th data-sortable="" style="width: 12.8667%;"><a
												href="#" class="dataTable-sorter">재고 출고 날짜</a></th>
											<th data-sortable="" style="width: 25.8667%;"><a
												href="#" class="dataTable-sorter">재고 상태</a></th>
									...
									<tbody>
										<c:forEach var="in" items="${list}">
											<tr>
												<td><a href="s_detail?s_id=${in.s_id}">${in.s_id}</a></td>
												<script>
													console.log("재고 아이디: "
															+ "${in.s_id}");
												</script>
