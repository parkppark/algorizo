			...
			<c:forEach var="dto" items="${detail }">
				...
				<div class="detail-section">
					<div class="detail-item">
						<label>입고 아이디:</label> <span>${dto.in_id }</span>
					</div>
					<div class="detail-item">
						<label>입고 날짜:</label> <span>${dto.in_date}</span>
					</div>
					<div class="detail-item">
						<label>수정 날짜:</label> <span>${dto.update_date}</span>
					</div>
					<div class="detail-item">
						<label>입고 상태:</label> <span>${dto.in_status}</span>
					</div>
					<div class="detail-item">
				...
				<div class="button-container">
					<a href="${contextPath}/inbound/i_list" class="back-btn">목록</a> <a
						href="i_update?in_id=${dto.in_id}" class="back-btn">수정</a>
