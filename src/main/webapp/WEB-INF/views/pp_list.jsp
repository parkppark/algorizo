			...
			<div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="modal-title">조달 계획 조회</h5>
							...
							<div class="form_box">
								<form>
									...
									<div class="form_title">
										...
										<input type="text" class="form-control" id="detailCode" readonly="readonly">
									</div>
									<div class="form_meta">
									...
									<div class="form_product" id="form_product">
										...
										<div class="table_box">
											<table class="table table-bordered">
												...
												<thead class="table-light" id="detail_thead">
					...
					<div class="modal-footer" id="modal-footer">
						<button type="button" class="btn btn-outline-secondary" id="plan_update" onclick="updateMode()">수정</button>
					...
					<div class="modal-body">
						<div class="form_box">
							<form action="register" id="plan_register_form" method="post">
								...
								<div class="form_title">
									<label for="registerCode" class="form-label">계획 코드</label>
									<input type="text" class="form-control" id="registerCode" readonly="readonly">
								</div>
								<div class="form_meta">
									<div class="form_writer">
										<label for="registerWriter" class="form-label">계획 작성자</label>
										<input type="text" class="form-control" id="registerWriter" readonly="readonly">
										<input type="hidden" id="login_user" value="<%=user%>">
									</div>
									<div class="form_regdate">
								...
								<div class="form_product">
									...
									<div class="register_product_button_div">
										<button type="button" class="btn btn-secondary" onclick="registerRow(registerState , setRegisterState)">+ 품목 추가</button>
									</div>
									<div class="total_div" id="total_register_div">
										<h5 class="total_h5">총합계</h5>
	        ...
	        try{
	            ...
	            data.forEach(plan => {
	                ...
	                tr_content.innerHTML = `
	                    ...
	                    <td class="list_td">\${plan.plan_code}</td>
        ...
        let planState = {
            ...
            let registerState = {
                plan : {
                	plan_code : "" ,
                    plan_title : "" ,
                    plan_writer : login_user ,
                    plan_regdate : new Date().toISOString().slice(0, 10)
                } ,
                products: [] ,
                totalPrice : 0 ,
                productList : []
...
//          코드 생성
            ...
            function renderPlanModal(){
                ...
                document.getElementById("detailCode").value = plan.plan_code;
            ...
            async function renderRegisterModal(){
                ...
                document.getElementById("registerCode").value = await registerCode();
