	...
	<div id="main">
		...
		<div class="page-heading">
			...
			<section class="section">
				<div class="card">
					<div class="card-header"><h3>입고 목록</h3></div>
					<div class="card-body">
						<div
								...
								<table class="table table-striped dataTable-table" id="table1">
									<thead>
										<tr>
											<th data-sortable="" style="width: 12.8%;"><a href="#"
												class="dataTable-sorter">입고 아이디</a></th>
											<th data-sortable="" style="width: 12.8667%;"><a
												href="#" class="dataTable-sorter">입고 날짜</a></th>
											<th data-sortable="" style="width: 25.8667%;"><a
												href="#" class="dataTable-sorter">입고 상태</a></th>
									...
									<tbody>
										<c:forEach var="in" items="${list}">
											<tr>
												<td><a href="i_detail?in_id=${in.in_id}">${in.in_id}</td>
												<script>
													console.log("입고 아이디: "
															+ "${in.in_id}");
												</script>
